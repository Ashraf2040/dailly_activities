...
export function WeeklyPlanTable({
  ...
  downloadWeeklyPlanAsDocxRow: (id: string) => void;
}) {
  return (
            ...
            >
              ...
              <td className="px-4 py-3">
                <button
                  ...
                  className="mr-2 rounded-md bg-[#006d77] px-3 py-1.5 text-white shadow-sm ring-1 ring-[#006d77]/20 transition hover:bg-[#006d77]/90"
                >
                  Edit
                </button>
                <button
                  onClick={() => onDelete(plan.id)}
                  className="mr-2 rounded-md bg-[#e29578] px-3 py-1.5 text-white shadow-sm ring-1 ring-[#e29578]/20 transition hover:bg-[#e29578]/90"
                >
                  Delete
                </button>
                <button
                  onClick={() => onDownload(plan.id)}
                  className="mr-2 rounded-md bg-[#0f766e] px-3 py-1.5 text-white shadow-sm ring-1 ring-[#0f766e]/20 transition hover:bg-[#0f766e]/90"
                >
                  Download
                </button>
                <button
                  onClick={() => downloadWeeklyPlanAsDocxRow(plan.id)} 
                  className="rounded-md bg-[#e29578] px-3 py-1.5 text-white shadow-sm ring-1 ring-[#1e40af]/20 transition hover:bg-[#e29578]/90"
                >
                  Download DOCX
                </button>
              </td>
